...
def create_carteira_endpoint(carteira: CarteiraCreate, db: Session = Depends(get_db)) -> CarteiraRead:
...
def read_carteira_endpoint(carteira_id: UUID, db: Session = Depends(get_db)) -> CarteiraRead:
...
def delete_carteira_endpoint(carteira_id: UUID, db: Session = Depends(get_db)) -> Response:
